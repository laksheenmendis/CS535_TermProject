...
def run(rank, size, algo, epochs, learning_rate):
    ...
    if dist.get_rank() == 0:
        ...
        path_name = algo + "_" + str(epochs) + "_" + str(learning_rate) + "_" + "model.pth"
        torch.save(model.state_dict(), path_name)
        # torch.save(model.state_dict(), "best_model.pth")

        f = open("224_results.txt", "a")
...
def setup(rank, world_size):
    ...
    dist.init_process_group("gloo", rank=int(rank), world_size=int(world_size), init_method='tcp://madison:23402',
